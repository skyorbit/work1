...
public class FloatingActionButton extends ImageButton {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            ...
            mColorNormal = Color.parseColor("#ff0099cc");  // holo_blue_dark
            mColorPressed = Color.parseColor("#ff33b5e5"); // holo_blue_light
        }
        mType = TYPE_NORMAL;
        mShadow = true;
        ...
        if (attr != null) {
            try {
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
                    ...
                    //skyorbit: default float button color to be white
                    mColorNormal = Color.WHITE;
                    mColorPressed = Color.LTGRAY;
                } else {
                    mColorNormal = attr.getColor(R.styleable.FloatingActionButton_fab_colorNormal,
                            Color.parseColor("#ff0099cc"));  // holo_blue_dark
                    mColorPressed = attr.getColor(R.styleable.FloatingActionButton_fab_colorPressed,
                            Color.parseColor("#ff33b5e5")); // holo_blue_light
                }
    ...
    private Drawable createDrawable(int color) {
        ...
        if (mShadow) {
            LayerDrawable layerDrawable = new LayerDrawable(
                    new Drawable[]{getResources().getDrawable(R.drawable.circle_shadow),
                            shapeDrawable});
    ...
    /**
     * A {@link android.os.Parcelable} representing the {@link org.telegram.ui.FloatingActionButton}'s
     * state.
     */
